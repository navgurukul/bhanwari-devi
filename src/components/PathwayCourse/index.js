...
function PathwayCourse() {
  ...
  const handleModal = () => {
    ...
    axios({
      method: METHODS.GET,
      url: pathwayCode
        ? `${process.env.REACT_APP_MERAKI_URL}/certificate/teachercertificate?pathwayId=10`
        : `${process.env.REACT_APP_MERAKI_URL}/certificate?pathwayId=1`,
      headers: {
