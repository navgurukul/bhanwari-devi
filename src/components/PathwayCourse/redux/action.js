export const types = {
  ...
  GET_PATHWAY_COURSE_INTENT: "GET_PATHWAY_INTENT",
  GET_PATHWAY_COURSE_INTENT_RESOLVED: "GET_PATHWAY_INTENT_RESOLVED",
  GET_PATHWAY_COURSE_INTENT_REJECTED: "GET_PATHWAY_INTENT_REJECTED",
};
