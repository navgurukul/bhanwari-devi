...
//         cy.get('.css-1t6c9ts > :nth-child(1)').contains('Learn').trigger('mouseover')
//         cy.get('.MuiList-root > :nth-child(10)').contains('Miscellaneous Courses').click()
...
//         cy.get('.css-1t6c9ts > :nth-child(3)').contains('Get Involved').trigger('mouseover')
//         cy.get('.css-1n5rj9b > .MuiPaper-root > .MuiList-root > :nth-child(2)').contains('Our Partner').click()
